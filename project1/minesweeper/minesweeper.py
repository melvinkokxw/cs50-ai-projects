    ...
    def add_knowledge(self, cell, count):
        ...
        def check_inference(sentence):
            ...
            if safe_cells is not None:
                ...
                for other_sentence in MinesweeperAI.knowledge:
                    if sentence.cells < other_sentence.cells or sentence.cells > other_sentence.cells:
                        new_sentence = Sentence(sentence.cells ^ other_sentence.cells, abs(sentence.count - other_sentence.count))
        ...
        new_sentence = Sentence(nearby_cells(cell), count)
        self.knowledge.append(new_sentence)

        while True:
            new_data = False
            for sentence in self.knowledge:
                if check_inference(sentence):
                    new_data = True
